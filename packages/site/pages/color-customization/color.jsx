...
export default function ColorCustomization() {
  ...
  const fetchColor = async () => {
    ...
    try {
      ...
      const ColorCustomization = await loadColorCustomization(userAuthPub);
      setColors(ColorCustomization);
    } catch (error) {
      handleError(error);
    }
  };
