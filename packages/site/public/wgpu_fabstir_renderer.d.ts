...
*/
export function stop_render(): Promise<void>;
/**
* @param {Array<any>} model_uris
* @param {Array<any>} extensions
*/
export function load_model(model_uris: Array<any>, extensions: Array<any>): void;
/**
...
* @returns {Promise<void>}
*/
export function render_model(canvas: HTMLCanvasElement, model_uris: Array<any>, extensions: Array<any>, callback: any): Promise<void>;

export type InitInput = RequestInfo | URL | Response | BufferSource | WebAssembly.Module;

export interface InitOutput {
  readonly memory: WebAssembly.Memory;
  readonly stop_render: () => number;
  readonly load_model: (a: number, b: number) => void;
  readonly render_model: (a: number, b: number, c: number, d: number) => number;
  ...
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h3c58673e57ac5206: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h624db408e04fd309: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A_B___Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h19e451bca4e87b90: (a: number, b: number, c: number, d: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h212aa6bec4947e03: (a: number, b: number, c: number) => void;
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7d8fa257b9984785: (a: number, b: number) => void;
  readonly _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h13ededb89e550369: (a: number, b: number, c: number) => void;
  readonly __wbindgen_free: (a: number, b: number, c: number) => void;
  readonly __wbindgen_exn_store: (a: number) => void;
  readonly wasm_bindgen__convert__closures__invoke2_mut__hc80ec11dbbbf5f6b: (a: number, b: number, c: number, d: number) => void;
}
