...
export const ConnectButton = (
  props: ComponentProps<'button'> & { theme: string },
) => {
  return (
    <button
      {...props}
...
export const HeaderButtons = ({
  ...
  return (
    <div
      className={` flex items-center justify-center text-sm rounded border border-white bg-white text-black font-bold px-4 py-2 ${theme === 'dark' ? 'bg-dark-background text-white' : 'bg-white text-black'}`}
    >
