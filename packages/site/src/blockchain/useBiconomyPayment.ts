...
export default function useBiconomyPayment(
  ...
  const handleBiconomyPaymentSponsor = async (userOp: any) => {
    ...
    console.log('useMintNFT: biconomyPaymaster = ', biconomyPaymaster);
    console.log('useMintNFT: paymasterServiceData = ', paymasterServiceData);

    const paymasterAndDataResponse =
      await biconomyPaymaster.getPaymasterAndData(userOp, paymasterServiceData);
    console.log(
      'useMintNFT: paymasterAndDataResponse = ',
